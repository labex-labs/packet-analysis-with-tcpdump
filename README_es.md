...
<p align="center">
  <a href="https://labex.io/es/courses/packet-analysis-with-tcpdump">
    <img src="https://course-cover.labex.io/packet-analysis-with-tcpdump.png?lang=es" alt="Análisis de paquetes con tcpdump">
  </a>
</p>
...
[Iniciar curso en LabEx](https://labex.io/es/courses/packet-analysis-with-tcpdump)

## Ejercicios

|   Índice | Nombre                                | Dificultad   | Práctica                                                                                                                                                |
|----------|---------------------------------------|--------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Interfaz de red y captura básica      | Principiante | <a target='_blank' href='https://labex.io/es/labs/linux-network-interface-and-basic-capture-656115?course=packet-analysis-with-tcpdump'>Iniciar lab</a> |
|        2 | Filtros de paquetes de Berkeley (BPF) | Principiante | <a target='_blank' href='https://labex.io/es/labs/linux-berkeley-packet-filters-bpf-656113?course=packet-analysis-with-tcpdump'>Iniciar lab</a>         |
|        3 | Inspección del contenido de paquetes  | Principiante | <a target='_blank' href='https://labex.io/es/labs/linux-inspecting-packet-contents-656114?course=packet-analysis-with-tcpdump'>Iniciar lab</a>          |
|        4 | Gestión de archivos PCAP              | Principiante | <a target='_blank' href='https://labex.io/es/labs/linux-pcap-file-management-656116?course=packet-analysis-with-tcpdump'>Iniciar lab</a>                |
|        5 | Analizar archivos PCAP con tcpdump    | Intermedio   | <a target='_blank' href='https://labex.io/es/labs/linux-analyze-pcap-files-with-tcpdump-656112?course=packet-analysis-with-tcpdump'>Iniciar desafío</a> |
